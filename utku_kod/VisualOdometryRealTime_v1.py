# -*- coding: utf-8 -*-
"""
Created on Mon May 22 18:43:15 2023
...
class VO():
    def __init__(self,P0, P1, img0, detector='sift', matching='BF', filter_match_distance=None, 
        ...
        self.P0 = P0
        self.P1 = P1
        self.current_image = img0 #image and its timestamp -> tuple
        ...
        print('VO Object is constructed!')

    def run(self, img1, img1_ts, remaining):
        print('VO still running, remaining count', remaining)
        frame_time = self.current_image[1]
        frame = self.current_image[0]
        ...
        self.current_image = (img1, img1_ts)
